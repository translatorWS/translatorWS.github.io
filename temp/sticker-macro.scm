(define (script-fu-sticker-template image layer)
  ...
  (define new-height (/ (* height 4200) width))
    ...
    (aset up-x 1 -1.000000)
    (aset up-x 2 -1.000000)
    (aset up-x 3 -1.000000)
    (aset up-x 4 +0.266667)
    ...
    (aset up-y 0 +0.500000)
    (aset up-y 1 -1.000000)
    (aset up-y 2 +0.525490)
    (aset up-y 3 +0.552941)
    (aset up-y 4 +0.576471)
    ...
    (aset up-y 11 +0.458824)
    (aset up-y 12 +0.466667)
    (aset up-y 13 +0.533333)
    (aset up-y 14 -1.000000)
    (aset up-y 15 -1.000000)
    (aset up-y 16 +0.500000)
    ))
